...
const Intro = () => {
  return (
    <div className="w-10/12 m-auto mt-14 h-screen text-center lg:flex lg:min-h-80 lg:items-center lg:justify-center lg:mt-10 lg:gap-40">
      <div>
        <img
